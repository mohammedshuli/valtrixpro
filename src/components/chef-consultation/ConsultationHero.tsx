...
export default function ConsultationHero() {
  return (
    <section className="relative overflow-hidden bg-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(230,165,32,0.15),_transparent_32%),linear-gradient(180deg,rgba(255,215,122,0.10),transparent_70%)] pointer-events-none" />
        ...
        <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] items-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl xl:text-7xl font-playfair font-black text-[#7A4A00] leading-tight tracking-[-0.03em]">
              Professional Culinary Consultation & Hospitality Expertise
            </h1>
            <p className="max-w-2xl text-lg md:text-xl text-[#4d3a23] leading-relaxed">
              Strategic menu consultation, culinary guidance, and premium hospitality advisory from Valtrix Pro Chef's executive culinary team.
            </p>
          ...
          >
            <img
              src={heroImage}
              alt="Chef consultation and professional culinary guidance"
